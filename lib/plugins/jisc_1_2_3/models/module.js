...
const schema = new mongoose.Schema({
  ...
  MOD_LEVEL: { type: String, maxLength: 1, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP, scopes.OPENDASH] },
...
export default getConnection('JISC_1_2_3').model('Module', schema, 'jiscModules');
