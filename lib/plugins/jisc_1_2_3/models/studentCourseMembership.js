...
import entryQuals from 'lib/plugins/jisc_1_2_3/utils/entryQuals';
...
const schema = new mongoose.Schema({
  ...
  WITHDRAWAL_REASON: { type: Number, required: true, min: 2, max: 99, default: 99, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  ...
  COURSE_AIM_ATTAINED: {
    ...
    readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  COURSE_MARK: { type: Number, min: 1, max: 100, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
...
export default getConnection('JISC_1_2_3').model('StudentCourseMembership', schema, 'jiscStudentCourseMemberships');
