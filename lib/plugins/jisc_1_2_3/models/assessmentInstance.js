...
import {
  ...
  updateLocalSingular,
  updateLocalMultiple
} from 'lib/plugins/jisc_1_2_3/utils/relations';
...
const updateForeignRelations = (model, next) => {
  const StudentAssessmentInstance = getConnection('JISC_1_2_3').model(
...
export default getConnection('JISC_1_2_3').model(
  'AssessmentInstance',
  schema,
