...
const schema = new mongoose.Schema({
  ...
  ASSESS_SEQ_ID: { type: Number, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.STUDENT_APP, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  ...
  ASSESS_AGREED_MARK: { type: Number, min: 1, max: 100, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.STUDENT_APP, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  ASSESS_ACTUAL_MARK: { type: Number, min: 1, max: 100, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.STUDENT_APP, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  ASSESS_AGREED_GRADE: { type: String, maxLength: 255, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.STUDENT_APP, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  ASSESS_ACTUAL_GRADE: { type: String, maxLength: 255, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.STUDENT_APP, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  ASSESSMENT_CURRENT_ATTEMPT: { type: Number, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.STUDENT_APP, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  ASSESSMENT_RESULT: { type: Number, min: 1, max: 4, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.STUDENT_APP, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
...
const updateForeignRelations = (model, next) => {
  ...
  const AssessmentInstance = getConnection('JISC_1_2_3').model('AssessmentInstance');
...
export default getConnection('JISC_1_2_3').model('StudentAssessmentInstance', schema, 'jiscStudentAssessmentInstances');
