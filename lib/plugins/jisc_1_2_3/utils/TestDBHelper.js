...
import Student from 'lib/plugins/jisc_1_2_3/models/student';
import StudentModuleInstance from 'lib/plugins/jisc_1_2_3/models/studentModuleInstance';
import StudentCourseInstance from 'lib/plugins/jisc_1_2_3/models/studentCourseInstance';
import Course from 'lib/plugins/jisc_1_2_3/models/course';
import CourseInstance from 'lib/plugins/jisc_1_2_3/models/courseInstance';
import Module from 'lib/plugins/jisc_1_2_3/models/module';
import ModuleInstance from 'lib/plugins/jisc_1_2_3/models/moduleInstance';
import ModuleVleMap from 'lib/plugins/jisc_1_2_3/models/moduleVleMap';
import Institution from 'lib/plugins/jisc_1_2_3/models/institution';
import AssessmentInstance from 'lib/plugins/jisc_1_2_3/models/assessmentInstance';
import Staff from 'lib/plugins/jisc_1_2_3/models/staff';
import StaffCourseInstance from 'lib/plugins/jisc_1_2_3/models/staffCourseInstance';
import StaffModuleInstance from 'lib/plugins/jisc_1_2_3/models/staffModuleInstance';
import StudentAssessmentInstance from 'lib/plugins/jisc_1_2_3/models/studentAssessmentInstance';
import StudentCourseMembership from 'lib/plugins/jisc_1_2_3/models/studentCourseMembership';

import User from 'lib/models/user';
import subjectCodes from 'lib/plugins/jisc_1_2_3/utils/subjectCodes';
import aimCodes from 'lib/plugins/jisc_1_2_3/utils/aimCodes';
...
export default class JiscDBHelpers {
   ...
   */
  prepareClient = (done, clientScopes = [scopes.ALL]) => {
    async.parallel({
      organisation: insertDone => Organisation.create({
        _id: this.defaultId,
        name: 'Test organisation'
      }, insertDone),

      user: insertDone => User.create({
        _id: this.defaultId,
      ...
      client: insertDone => Client.create({
        _id: this.defaultId,
        organisation: this.defaultId,
        user: this.defaultId,
        scopes: clientScopes,
  ...
  getStudentModuleInstanceData = (studentId = this.studentId, modInstanceId = this.modInstanceId) =>
     ({
       STUDENT_ID: studentId,
  ...
  prepStudentModuleInstance = (done, data = this.getStudentModuleInstanceData()) => {
  ...
  prepStudentCourseInstance = (done, data = this.getStudentCourseInstanceData()) => {
  ...
  // MODULE INSTANCE
  getModuleInstanceData = (moduleId = this.moduleId, modInstanceId = this.modInstanceId) =>
     ({
       MOD_INSTANCE_ID: modInstanceId,
       MOD_ID: moduleId,
       MOD_ONLINE: 1,
  ...
  prepStaffCourseInstance = (done, data = this.getStaffCourseInstanceData()) => {
  ...
  getStaffModuleInstanceData = (staffId = this.staffId, modInstanceId = this.modInstanceId) =>
     ({
       STAFF_ID: staffId,
       MOD_INSTANCE_ID: modInstanceId
     })
  ...
  prepStaffModuleInstance = (done, data = this.getStaffModuleInstanceData()) => {
  ...
  getStudentAssessmentInstanceData = (studentId = this.studentId, modInstanceId = this.modInstanceId) =>
     ({
       STUDENT_ID: studentId,
  ...
  prepStudentAssessmentInstance = (done, data = this.getStudentAssessmentInstanceData()) => {
    const studentAssessmentInstanceData = this.addOrganistionData(data);
    StudentAssessmentInstance.create(studentAssessmentInstanceData, (err, model) => {
  ...
  getStudentCourseMembershipData = (studentId = this.studentId, courseId = this.courseId) =>
     ({
       STUDENT_ID: studentId,
       COURSE_ID: courseId,
       STUDENT_COURSE_MEMBERSHIP_ID: this.defaultId,
  ...
  prepStudentCourseMembership = (done, data = this.getStudentCourseMembershipData()) => {
    const studentCourseMembershipData = this.addOrganistionData(data);
    StudentCourseMembership.create(studentCourseMembershipData, (err, model) => {
