...
import { JISC_DEFAULTS } from 'lib/plugins/jisc_1_2_7/constants/auth';
import * as settings from 'lib/plugins/jisc_1_2_7/constants/settings';
import * as routes from 'lib/plugins/jisc_1_2_7/constants/routes';
import marked from 'marked';

// STUDENT DATA
import Student from 'lib/plugins/jisc_1_2_7/models/student';
import StudentCourseInstance from 'lib/plugins/jisc_1_2_7/models/studentCourseInstance';
import StudentModuleInstance from 'lib/plugins/jisc_1_2_7/models/studentModuleInstance';
import AssessmentInstance from 'lib/plugins/jisc_1_2_7/models/assessmentInstance';
import Course from 'lib/plugins/jisc_1_2_7/models/course';
import CourseInstance from 'lib/plugins/jisc_1_2_7/models/courseInstance';
import Module from 'lib/plugins/jisc_1_2_7/models/module';
import ModuleInstance from 'lib/plugins/jisc_1_2_7/models/moduleInstance';
import ModuleVleMap from 'lib/plugins/jisc_1_2_7/models/moduleVleMap';
import Institution from 'lib/plugins/jisc_1_2_7/models/institution';
...
import StudentAssessmentInstance from 'lib/plugins/jisc_1_2_7/models/studentAssessmentInstance';
import StudentCourseMembership from 'lib/plugins/jisc_1_2_7/models/studentCourseMembership';
import docs from 'lib/plugins/jisc_1_2_7/constants/docs/description.md';
