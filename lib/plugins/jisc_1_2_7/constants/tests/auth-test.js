// ./node_modules/mocha/bin/mocha lib/plugins/jisc_1_2_7/constants/tests/auth-test.js -r tests.babel

import sinon from 'sinon';
import httpMocks from 'node-mocks-http';
import { assert } from 'chai';
import * as auth from 'lib/plugins/jisc_1_2_7/constants/auth';
