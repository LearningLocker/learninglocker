...
import {
  ...
  updateLocalSingular,
  updateLocalMultiple
} from 'lib/plugins/jisc_1_2_7/utils/relations';
...
const updateForeignRelations = (model, removeRelations, next) => {
  const StudentAssessmentInstance = getConnection('JISC_1_2_7').model(
...
export default getConnection('JISC_1_2_7').model(
  'AssessmentInstance',
  schema,
