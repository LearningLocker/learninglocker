...
const schema = new mongoose.Schema({
  ...
  TITLE: { type: String, maxLength: 255, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  COURSE_AIM: {
    type: String,
    enum: {
...
export default getConnection('JISC_1_2_7').model('Course', schema, 'jiscCourses');
