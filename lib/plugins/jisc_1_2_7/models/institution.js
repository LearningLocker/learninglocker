...
import { updateForeignSingular, updateLocalMultiple } from 'lib/plugins/jisc_1_2_7/utils/relations';
...
const schema = new mongoose.Schema({
  ...
  TENANT_NAME: { type: String, maxLength: 255, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.STUDENT_APP, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP, scopes.OPENDASH] },
...
const updateForeignRelations = (model, removeRelations, next) => {
  ...
  async.parallel([
    done => updateForeignSingular(Course, model, removeRelations, {
...
export default getConnection('JISC_1_2_7').model('Institution', schema, 'jiscInstitutions');
