...
schema.index({ organisation: 1, STAFF_ID: 1, MOD_INSTANCE_ID: 1 }, { unique: true });
...
export default getConnection('JISC_1_2_7').model('StaffModuleInstance', schema, 'jiscStaffModuleInstances');
