...
describe('JISC REST API tests', () => {
    ...
    describe(
      ...
      testREST.bind(
        ...
        db,
        {
          data: postData,
          test: (res) => {
            if (res.body.STUDENT_ID !== postData.STUDENT_ID) { throw new Error('New model did not have the expected STUDENT_ID'); }
          }
        },
        {
          data: patchData,
    ...
    describe(
      ...
      testREST.bind(
        ...
        db,
        {
          data: postData,
          test: (res) => {
            if (res.body.COURSE_ID !== postData.COURSE_ID) { throw new Error('New model did not have the expected COURSE_ID'); }
          }
        },
        {
          data: patchData,
          test: (res) => {
            if (res.body.MODE !== patchData.MODE) { throw new Error('Patched model did not have the expected MODE'); }
          }
        }
      )
    );
    ...
    describe(
      ...
      testREST.bind(
        ...
        db,
        {
          data: postData,
          test: (res) => {
            if (res.body.MOD_ID !== postData.MOD_ID) { throw new Error('New model did not have the expected MOD_ID'); }
          }
        },
        {
          data: patchData,
    ...
    describe(
      ...
      testREST.bind(
        ...
        db,
        {
          data: postData,
          test: (res) => {
            if (res.body.VLE_MOD_ID !== postData.VLE_MOD_ID) { throw new Error('New model did not have the expected VLE_MOD_ID'); }
          }
        },
        {
          data: patchData,
    ...
    describe(
      ...
      testREST.bind(
        ...
        db,
        {
          data: postData,
          test: (res) => {
            if (res.body.TENANT_ID !== postData.TENANT_ID) { throw new Error('New model did not have the expected TENANT_ID'); }
          }
        },
        {
          data: patchData,
  ...
  describe('Test Staff Course Instance API', () => {
    ...
    beforeEach('Setup staff course instance', (beforeDone) => {
      db.prepStaffCourseInstance(beforeDone);
    });
    ...
    describe(
      ...
      testREST.bind(
        ...
        db,
        {
          data: postData,
          test: (res) => {
            if (res.body.STAFF_ID !== postData.STAFF_ID) { throw new Error('New model did not have the expected STAFF_ID'); }
          }
        },
        {
          data: patchData,
