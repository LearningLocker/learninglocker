...
const updateForeignRelations = (model, removeRelations, next) => {
  const Course = getConnection('JISC_1_2_6').model('Course');
  const StaffCourseInstance = getConnection('JISC_1_2_6').model('StaffCourseInstance');
  const StudentCourseInstance = getConnection('JISC_1_2_6').model('StudentCourseInstance');
...
export default getConnection('JISC_1_2_6').model('CourseInstance', schema, 'jiscCourseInstances');
