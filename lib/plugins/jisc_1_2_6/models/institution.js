...
import { updateForeignSingular, updateLocalMultiple } from 'lib/plugins/jisc_1_2_6/utils/relations';
...
export default getConnection('JISC_1_2_6').model('Institution', schema, 'jiscInstitutions');
