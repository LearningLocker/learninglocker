...
import domiciles from 'lib/plugins/jisc_1_2_6/utils/domiciles';
import ethnicityCodes from 'lib/plugins/jisc_1_2_6/utils/ethnicityCodes';
...
export default getConnection('JISC_1_2_6').model('Student', schema, 'jiscStudents');
