...
const updateForeignRelations = (model, removeRelations, next) => {
  ...
  const CourseInstance = getConnection('JISC_1_2_6').model('CourseInstance');
...
export default getConnection('JISC_1_2_6').model('StudentModuleInstance', schema, 'jiscStudentModuleInstances');
