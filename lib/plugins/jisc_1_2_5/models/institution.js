...
import { updateForeignSingular, updateLocalMultiple } from 'lib/plugins/jisc_1_2_5/utils/relations';
...
export default getConnection('JISC_1_2_5').model('Institution', schema, 'jiscInstitutions');
