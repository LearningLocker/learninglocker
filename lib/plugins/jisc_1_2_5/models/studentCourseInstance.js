...
const schema = new mongoose.Schema({
  ...
  YEAR_PRG: { type: Number, required: true, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  YEAR_STU: { type: Number, required: true, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  ...
  X_COURSE_AVERAGE_MARK: { type: Number, required: true, min: 0, max: 1, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  X_YEAR_AVERAGE_MARK: { type: Number, required: true, min: 0, max: 1, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
...
export default getConnection('JISC_1_2_5').model('StudentCourseInstance', schema, 'jiscStudentCourseInstances');
