...
const updateForeignRelations = (model, next) => {
  const Course = getConnection('JISC_1_2_5').model('Course');
  const StaffCourseInstance = getConnection('JISC_1_2_5').model('StaffCourseInstance');
...
export default getConnection('JISC_1_2_5').model('CourseInstance', schema, 'jiscCourseInstances');
