...
const schema = new mongoose.Schema({
  ...
  MOD_GRADE: { type: String, required: true, maxLength: 255, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  MOD_RESULT: { type: Number, required: true, min: 1, max: 4, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP, scopes.OPENDASH] },
  ...
  MOD_CREDITS_ACHIEVED: { type: String, required: true, maxLength: 255, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
  MOD_CURRENT_ATTEMPT: { type: String, required: true, maxLength: 255, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.LAP, scopes.SSP] },
...
const updateLocalRelations = (model, next) => {
  const Student = getConnection('JISC_1_2_5').model('Student');
  const ModuleInstance = getConnection('JISC_1_2_5').model('ModuleInstance');
  const CourseInstance = getConnection('JISC_1_2_5').model('CourseInstance');
...
export default getConnection('JISC_1_2_5').model('StudentModuleInstance', schema, 'jiscStudentModuleInstances');
