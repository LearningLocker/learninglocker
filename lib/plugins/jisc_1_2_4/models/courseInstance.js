...
const updateForeignRelations = (model, next) => {
  ...
  const StaffCourseInstance = getConnection('JISC_1_2_4').model('StaffCourseInstance');
  const StudentCourseInstance = getConnection('JISC_1_2_4').model('StudentCourseInstance');
  const StudentModuleInstance = getConnection('JISC_1_2_4').model('StudentModuleInstance');
  ...
  async.parallel([
    ...
    done => updateForeignSingular(StudentCourseInstance, model, query, 'courseInstance', done)
  ], next);
};
...
export default getConnection('JISC_1_2_4').model('CourseInstance', schema, 'jiscCourseInstances');
