...
const schema = new mongoose.Schema({
  ...
  PRIMARY_EMAIL_ADDRESS: { type: String, required: true, maxLength: 255, readAccess: [scopes.ALL, scopes.UDD_READ, scopes.TRIBAL_INSIGHT, scopes.SSP, scopes.OPENDASH] },
...
export default getConnection('JISC_1_2_4').model('Staff', schema, 'jiscStaff');
