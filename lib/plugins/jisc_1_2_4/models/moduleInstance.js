...
const updateForeignRelations = (model, next) => {
  const Module = getConnection('JISC_1_2_4').model('Module');
  const AssessmentInstance = getConnection('JISC_1_2_4').model('AssessmentInstance');
  const ModuleVleMap = getConnection('JISC_1_2_4').model('ModuleVleMap');
  const StaffModuleInstance = getConnection('JISC_1_2_4').model('StaffModuleInstance');
  const StudentAssessmentInstance = getConnection('JISC_1_2_4').model('StudentAssessmentInstance');
...
export default getConnection('JISC_1_2_4').model('ModuleInstance', schema, 'jiscModuleInstances');
