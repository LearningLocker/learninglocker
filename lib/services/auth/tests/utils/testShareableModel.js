...
export default ({
  ...
  describe(`model scope filters ${modelName}`, () => {
    ...
    testOrgScopeFilterOwner(modelName, 'view', TEST_PRIVATE_FILTER);
    testOrgScopeFilterOwner(modelName, 'edit', TEST_PRIVATE_FILTER);
    testOrgScopeFilterOwner(modelName, 'create', TEST_PRIVATE_FILTER);
    testOrgScopeFilterOwner(modelName, 'delete', TEST_PRIVATE_FILTER);
