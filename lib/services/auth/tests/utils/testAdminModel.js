...
export default ({ modelName, viewAllScope, editAllScope }) => {
  describe(`model scope filters ${modelName}`, () => {
    ...
    testOrgScopeFilterError(modelName, 'edit', [editAllScope], TEST_ORG_FILTER);
    testOrgScopeFilterError(modelName, 'create', [editAllScope], TEST_ORG_FILTER);
    testOrgScopeFilterError(modelName, 'delete', [editAllScope], TEST_ORG_FILTER);
