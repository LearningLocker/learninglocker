...
import { MANAGE_ALL_USERS, ALL as ORG_ALL } from 'lib/constants/orgScopes';
...
export default ({ authInfo }) => {
  ...
  const hasRequiredScope = intersection(scopes, [SITE_ADMIN, ALL, MANAGE_ALL_USERS, ORG_ALL]).length > 0;
  if (hasRequiredScope) {
