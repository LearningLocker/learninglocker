...
import getPersonasImportScopeFilter
  from 'lib/services/auth/modelFilters/personasImport';
import getPersonasImportTemplateScopeFilter
  from 'lib/services/auth/modelFilters/personasImportTemplate';
...
export default async (opts) => {
  switch (opts.modelName.toLowerCase()) {
    ...
    case 'personasimport':
      return getPersonasImportScopeFilter(opts);
    case 'personasimporttemplate': 
      return getPersonasImportTemplateScopeFilter(opts);
    default:
