...
export const createDeleteFromPath = client => ({ container }) => async (path) => {
  await promisify(client.removeFile, { context: client })(container, getPrefixedPath(path));
};
