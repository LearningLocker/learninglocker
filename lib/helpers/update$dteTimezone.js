...
import { UTC_BASED_ZONE_MAP } from 'lib/constants/timezones';

/**
 * @param {string} timezone - TZ database name (e.g. "Europe/Paris") or offset (e.g. '+03:00') in UTC_BASED_ZONE_MAP
 * @return {string} Z (e.g. "-08:00")
 */
const toZ = (timezone) => {
  if (UTC_BASED_ZONE_MAP.has(timezone) && timezone !== 'UTC') {
    return timezone;
  }
