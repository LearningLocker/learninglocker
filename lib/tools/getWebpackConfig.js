...
function getWebpackConfig(args) {
  ...
  var clientFreeVariables = args.clientFreeVariables || {};
  var serverFreeVariables = args.serverFreeVariables || {};

  var port = parseInt(process.env.UI_PORT, 10);
  var devPort = 3131;
  var assetPort = isDebug ? devPort : port;
  ...
  let banner = 'require("dotenv/config");\n';
