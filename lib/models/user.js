...
import addWSFunctions from 'lib/models/plugins/addWSFunctions';
...
const schema = new mongoose.Schema({
  ...
  liveWebsockets: { type: Boolean, default: true },
  liveUpdates: { type: Boolean, default: true },
  liveUpdatesOverrides: {
    statement: { type: Boolean, defult: false }
  }
});
