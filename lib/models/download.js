...
const getOrgExpireTTL = async (organisationId) => {
  ...
  const orgAllowsExportExpirations = _.get(organisation, 'settings.EXPIRE_EXPORTS.allowExportExpirations', false);
  const orgTTL = _.get(organisation, 'settings.EXPIRE_EXPORTS.ttl', undefined);
