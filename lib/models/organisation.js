...
const schema = new mongoose.Schema({
  ...
  settings: {
    ...
    RECOMMENDATION_WINDOW_SIZE: {
      type: String,
      default: 2419200,
      validate: {
        isAsync: true,
        validator: minVal.bind(null, 604800, 'Must be 7 or more days')
      }
    },
    RECOMMENDATION_NEW_PERIOD: {
      type: String,
      default: 1209600,
      validate: {
        isAsync: true,
        validator: minVal.bind(null, 86400, 'Must be 86400 or more seconds')
      }
    },
