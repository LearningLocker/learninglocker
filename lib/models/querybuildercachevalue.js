...
import { SHOW, HIDE } from 'lib/constants/recommendation';
...
const schema = new mongoose.Schema({
  ...
  count: { type: Number },
  recommendationWindowCount: { type: Number },
  recommendationWindowStart: { type: Date },
  recommendationStatus: { type: String, enum: [SHOW, HIDE], default: SHOW }
});
