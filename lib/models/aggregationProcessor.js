...
const AGGREGATION_BLOCK_SIZE_SECONDS = defaultTo(Number(process.env.AGGREGATION_BLOCK_SIZE_SECONDS), 86400);
...
const aggregationProcessorSchema = new mongoose.Schema({
  ...
  blockSizeSeconds: { type: Number, default: AGGREGATION_BLOCK_SIZE_SECONDS }, // In seconds
