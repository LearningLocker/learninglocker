...
export const STATEMENTS_AGGREGATION_PROCESSOR_INITIALISE = '/statements/aggregate/initialise';
export const STATEMENTS_AGGREGATION_PROCESSOR_RESULTS = '/statements/aggregate/results/:id';
export const STATEMENTS_AGGREGATION_PROCESSOR_DELETE = '/statements/aggregate/clear';
