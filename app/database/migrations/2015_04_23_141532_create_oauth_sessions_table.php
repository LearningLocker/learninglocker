...
class CreateOauthSessionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql')->create('oauth_sessions', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::connection('mysql')->table('oauth_sessions', function (Blueprint $table) {
            $table->dropForeign('oauth_sessions_client_id_foreign');
        });
        Schema::connection('mysql')->drop('oauth_sessions');
    }
}
