...
class OAuthTest extends \Tests\LrsTestCase {
  ...
  public function setup() {
    ...
    \DB::getMongoDB()->oauth_clients->insert([
      'client_id' => $this->client->api['basic_key'],
      'client_secret' => $this->client->api['basic_secret'],
  ...
  public function testAccessTokenViaClient() {
    $response = $this->requestToken($this->client->api['basic_key'], $this->client->api['basic_secret']);
  ...
  public function testAccessViaToken() {
    $token_response = $this->requestToken($this->client->api['basic_key'], $this->client->api['basic_secret']);
