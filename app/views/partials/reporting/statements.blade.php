...
@section('title')
  ...
  <ol class="breadcrumb">
    <li><a href="{{ route('reporting.index', [$report->lrs_id]) }}" data-toggle="tooltip" data-placement="bottom" title="View all of the reports for this LRS">{{ Lang::get('statements.reporting') }}</a></li>
